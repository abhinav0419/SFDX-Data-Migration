...
def export(sobject):
    ...
    mapSobjectRecords[sobject] = json.loads(subprocess.check_output("sfdx force:data:soql:query -u {0} --json -q \"{1}\"".format(srcOrg, query), shell=True).decode("UTF-8"))["result"]
